# ============================================================
# Uninstall-Agent.ps1
# Odinstalace USB Guardian agenta (sluzba + watchdog).
#
# Co dela:
#   1. Zastavi a smaze sluzbu "USB Guardian".
#   2. Zrusi watchdog scheduled task.
#   2b. Zrusi OBA scheduled tasky (watchdog i ToastHelper) + prazdnou slozku uloh.
#   3. Volitelne (-RemoveFiles) smaze C:\Program Files\USBGuardian.
#   4. Volitelne (-RemoveData) smaze i C:\ProgramData\USBGuardian.
#
# ZACHOVAVA C:\ProgramData\USBGuardian (fronta incidentu, whitelist) -
# smaz rucne jen pokud opravdu chces prijit o lokalni audit.
#
